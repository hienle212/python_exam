...
routes['/main'] ='Welcome#main'
routes['POST']['/addquote'] = 'Welcome#add_quote'
routes['POST']['/removequote'] = 'Welcome#delete_quote'
routes['POST']['/createquote'] = 'Welcome#create_quote'
routes['/viewinfo/<user_id>'] = 'Welcome#quote_info'

routes['/logout'] ='Welcome#logoff'
